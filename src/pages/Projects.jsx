...
export default function Projects() {
  return (
    <div className='animate__animated animate__heartBeat animate__repeat-1 min-h-screen max-w-2xl mx-auto flex justify-center items-center flex-col gap-6 p-3'>
